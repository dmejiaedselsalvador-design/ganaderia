        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('proveedor.nuevo')  }}" method="POST" id="form-create-proveedor">
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('adelantos.proveedores.index') }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 transition">
                        Cancelar
                    </a>
                    <button type="submit"
