...
<head>
    ...
    <title>Sistema de Ganadería - Exportación EE.UU.</title>
...
<body class="bg-slate-100 font-sans antialiased">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="hidden md:flex flex-col w-64 bg-slate-900 text-slate-300">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <button onclick="cambiarVista('inventario')" id="btn-inventario" class="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-slate-800 transition">
                    <i class="fa-solid id-card fa-list-check"></i> Inventario (Aretes)
                </button>
        ...
        <div class="flex-1 flex flex-col overflow-y-auto">
            ...
            <!-- Barra Superior -->
            <header class="h-16 bg-white shadow-xs flex items-center justify-between px-6 z-10">
                <div class="flex items-center gap-4">
                    <h1 id="titulo-vista" class="text-xl font-bold text-slate-800">Panel de Control de Ganado</h1>
                </div>
                <div class="flex items-center gap-3">
                    <span class="text-sm font-medium text-slate-600">Rancho San José</span>
