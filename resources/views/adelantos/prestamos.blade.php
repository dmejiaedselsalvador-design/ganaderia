<x-app-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="#" method="POST" id="form-adelanto-proveedor">
                @csrf
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        ...
                        <!-- Fecha de Adelanto -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Fecha de Adelanto *</label>
                            <input type="date" name="advance_date" value="{{ date('Y-m-d') }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        </div>

                        <!-- Tipo de Adelanto (Efectivo / Especie) -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tipo de Transacción *</label>
                            <select name="type" id="tipo_transaccion" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <option value="Efectivo">Préstamo / Efectivo</option>
                                <option value="Especie">Entrega en Especie (Insumos/Concentrado)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 space-y-4">
                        <h3 class="text-md font-medium text-gray-800 dark:text-gray-200">Detalle del Concepto y Equivalencia</h3>
                        
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <!-- Concepto -->
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Concepto / Descripción *</label>
                                <input type="text" name="concept" id="input_concept" placeholder="Ej. Préstamo personal o 2 sacos de concentrado" required
                                ...
                                <span class="text-xs text-gray-500 mt-1 block">Detalle qué se le entrega al proveedor (dinero o productos).</span>
                            </div>

                            <!-- Monto Equivalente -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Monto Equivalente ($) *</label>
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <span class="text-gray-500 sm:text-sm">$</span>
                                    </div>
                                    <input type="number" step="0.01" name="amount" id="input_amount" placeholder="0.00" required
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Observaciones / Notas</label>
                            <textarea name="observations" rows="2" placeholder="Notas adicionales sobre acuerdos de devolución, descuento en próximos lotes, etc."
                ...
                <!-- Resumen Rápido -->
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4 mb-6 flex justify-between items-center">
                    <span class="text-sm text-gray-600 dark:text-gray-400">Total a registrar como adelanto al proveedor:</span>
                    <span class="text-xl font-bold text-indigo-600 dark:text-indigo-400">$<span id="display-total">0.00</span></span>
                </div>
